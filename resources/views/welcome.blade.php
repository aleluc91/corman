...
@section('content')
    <div class="jumbotron">
        <div class="container">
            <h1 class="display-4">WELCOME TO <span class="text-info">CORMAN</span></h1>
            <h2>Are you a researcher? Join our community , it's free.</h2>
            <p><a class="btn btn-primary btn-lg" href="{{ route('register') }}" role="button">Sign up &raquo;</a></p>
        </div>
    </div>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <h2>Organize your publications</h2>
                <p>You can automatically upload the publications you have already created, using an indexing service (dblp).</p>
            </div>
            <div class="col-md-4">
                <h2>Manage your publications</h2>
                <p>You can create new publications or extend those already present</p>

            </div>
            <div class="col-md-4">
                <h2>Create collaborative groups</h2>
                <p>You can create collaborative groups in which you and other users can share your publications.</p>
            </div>
        </div>
